...
plt.legend()
plt.subplot(3,3,4)
plt.plot(d4x,d4y, label = "dt = 0.0001")
plt.title("Runge Kutta")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
plt.subplot(3,3,5)
plt.plot(d5x,d5y, label = "dt = 0.0001")
plt.title("Euler")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
plt.subplot(3,3,6)
plt.plot(d6x,d6y, label = "dt = 0.0001")
plt.title("Leap Frog")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
...
plt.figure(figsize=(10,10))
plt.subplot(3,3,1)
plt.plot(d1Vx,d1Vy, label = "dt = 0.01")
plt.title("Runge Kutta")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
...
plt.legend()
plt.subplot(3,3,3)
plt.plot(d3Vx,d3Vy, label = "dt = 0.01")
plt.title("Leap Frog")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
plt.subplot(3,3,4)
plt.plot(d4Vx,d4Vy, label = "dt = 0.0001")
plt.title("Runge Kutta")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
plt.subplot(3,3,5)
plt.plot(d5Vx,d5Vy, label = "dt = 0.0001")
plt.title("Euler")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
plt.subplot(3,3,6)
plt.plot(d6Vx,d6Vy, label = "dt = 0.0001")
plt.title("Leap Frog")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
plt.subplot(3,3,7)
plt.plot(d7Vx,d7Vy, label = "dt = 0.001")
plt.title("Runge Kutta")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
...
plt.legend()
plt.subplot(3,3,9)
plt.plot(d9Vx,d9Vy, label = "dt = 0.001")
plt.title("Leap Frog")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend()
